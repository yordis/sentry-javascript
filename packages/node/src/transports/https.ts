...
import { Event, Response, SessionAggregates, SessionContext, TransportOptions } from '@sentry/types';
...
export class HTTPSTransport extends BaseTransport {
   ...
   * @inheritDoc
   */
  public sendSession(session: SessionContext | SessionAggregates): PromiseLike<Response> {
